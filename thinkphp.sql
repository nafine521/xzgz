...
CREATE TABLE `xz_project`(
  id int UNSIGNED AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
  aid INT UNSIGNED NOT NULL DEFAULT '' COMMENT '关联内容id',
  name char(100) NOT NULL DEFAULT '' COMMENT '名称',
  expression INT UNSIGNED NOT NULL DEFAULT '' COMMENT '项目周期',
  exp_start  INT UNSIGNED NOT NULL DEFAULT '' COMMENT '开始时间',
  exp_stop  INT UNSIGNED NOT NULL DEFAULT '' COMMENT '结束时间',

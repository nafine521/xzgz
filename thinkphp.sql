...
CREATE TABLE `xz_project`(
  id int UNSIGNED AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
  aid INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '关联内容id',
  type VARCHAR(20) NOT NULL DEFAULT '' COMMENT '项目类型',
  name char(100) NOT NULL DEFAULT '' COMMENT '名称',
  expression INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '项目周期',
  exp_start  INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '开始时间',
  exp_stop  INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '结束时间',
  annual_income DOUBLE(6,2) NOT NULL DEFAULT '0.00' COMMENT '年化收益',
  attr_id MEDIUMINT NOT NULL DEFAULT '0' COMMENT '项目属性',
  ...
  item_status TINYINT NOT NULL DEFAULT '0' COMMENT '0 未上线 1上线中 2 已完成'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='项目表';

-- 项目类型
CREATE TABLE `xz_project_type`(
  id int UNSIGNED AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
  pid INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '父键',
  name VARCHAR(20) NOT NULL DEFAULT '' COMMENT '名称'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='项目类型表';

...
class IndexController extends Controller{
	...
	public function index(){
		...
		$gid=2;
		$array=array(
				'WIDout_trade'=>date('YmdHis',time()).'u'.$uid.'g'.$gid,
				'orderName'=>"购买商品的名称",
				'price'=>0.01,
				'orderdescription'=>"这里是商品的描述，也可以是订单的描述",
				'orderthum'=>'./ueditor/php/upload/image/20150731/1438328014454759_thumb.jpg',
		);
		$this->assign('alipayData',$array);
		$this->display();
	}

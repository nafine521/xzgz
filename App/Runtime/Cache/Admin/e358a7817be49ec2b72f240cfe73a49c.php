    ...
    <form class="form form-horizontal" action="" method="post" id="login">
      <div class="row cl">
        ...
        <div class="formControls col-8">
          <input id="" name="ue_username" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-8">
          <input id="" name="ue_password" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          <input class="input-text size-L" name="verify" type="text" placeholder="验证码"   style="width:150px;">
          <img src="<?php echo U('Index/verify');?>"onclick="this.src='verify?d='+Math.random();"> <a class="ghyzm" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row">
        <div class="formControls col-8 col-offset-3">
          <label for="online">

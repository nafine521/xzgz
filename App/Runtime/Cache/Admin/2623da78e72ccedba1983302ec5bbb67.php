...
<div class="pd-20" style="padding-top:20px;">
  ...
  <p>登录次数：<?php echo ($_SESSION['admin_session']['ue_login_num']); ?> </p>
  <p>上次登录IP：<?php echo ($_SESSION['admin_session']['ue_login_ip']); ?>  上次登录时间：<?php echo ($_SESSION['admin_session']['ue_login_time']); ?></p>

...
//			});
    ...
    (function() {
        ...
        _extend('calculate', function(which) {
            ...
            // 弹出窗
            calcWin = popOut({
                title: '<ul class="calc-tab float-l"><li class="active">理财计算器</li><li>阿诺币</li><li>奖励</li></ul>',
                scrollable: false,
				...
				<div class="aruo-calc calc-body" style="display:none;"><div class="calc-content"><div class="form-line"><div class="change-type"><span>投资额度</span><button></button><span>阿诺币</span></div></div><div class="form-line"><label><span id="money-prefix">投资额度</span><input maxlength="7" id="aruo-money" style="width:275px;right:0;" type="text" value="" /></label></div><div class="form-line"><label>投资期限<input maxLength="3" id="aruo-date" type="text" value="" /><em class="ipt-suffix">天</em></label></div><div class="form-line"><input style="width:200px;margin-right:75px;margin-top:12px;" type="button" id="aruo-confirm" value="立即计算" /></div></div><div class="calc-footer aruo-calc-footer"><div class="form-line"><div class="aruo-calc-res"><p>货币兑换</p></div></div></div></div>\
